...
#include <iostream>
#include "Logger.h"
#include "TexGenLoader.h"

using namespace std;

void Utils::TexGenLoader::loadTetFile(const std::string &filename, std::vector<Vector3r> &vertices, std::vector<unsigned int> &tets)
{
...
void Utils::TexGenLoader::loadTetgenModel(const std::string &nodeFilename, const std::string &eleFilename, std::vector<Vector3r> &vertices, std::vector<unsigned int> &tets)
{
...
void Utils::TexGenLoader::loadMSHModel(const std::string &mshFilename, std::vector<Vector3r> &vertices, std::vector<unsigned int> &tets)
{
